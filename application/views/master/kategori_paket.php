          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="mskategori-paket-add.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-append">
                          <a href="<?=site_url('master/DataMaster/KategoriPaketAdd')?>" class="btn btn-primary" data-toggle="tooltip" title="Create">
