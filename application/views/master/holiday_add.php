...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="dist/img/loadingicon.png" alt="icon loading" height="auto">
    </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="#" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
            ...
            <div class="card-header">
              ...
              <div class="row">
                <div class="col-md-12 text-right">
                  <a href="msholiday.html" button type="button" class="btn btn-outline-success"
