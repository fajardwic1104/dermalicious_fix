          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="msholiday.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Date</label>
                      <div class="input-group date" id="tglholiday" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#tglholiday" />
                        <div class="input-group-append" data-target="#tglholiday" data-toggle="datetimepicker">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-append">
                          <a href="<?=site_url('master/DataMaster/HolidayAdd')?>" class="btn btn-primary" data-toggle="tooltip" title="Create">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="msholiday-edit.html" class="btn btn-warning" data-toggle="tooltip"
