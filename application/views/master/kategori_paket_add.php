...
<head>
    ...
    <title>Kategori Paket - Add</title>
</head>
<body>
    ...
    <div class="content-wrapper" style="margin-left : auto">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-8">
              <h1>Create Master Kategori Paket</h1>
            </div><!-- /.col -->
            <div class="col-sm-4">
              <div class="button-create">
                <a href="mskategori-paket.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" value="Healthy001" placeholder="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Kategori Paket</label>
                      <input class="form-control" type="text" value="Healthy A" placeholder="">
                    </div>
                  </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-md-12 text-right">
                    <a href="mskategori-paket.html" button type="button" class="btn btn-outline-success"
