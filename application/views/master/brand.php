          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="msperusahaan.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-append">
                          <a href="<?=site_url('master/DataMaster/BrandAdd')?>" class="btn btn-primary" data-toggle="tooltip" title="Create">
                  ...
                  <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>001</td>
                          <td>PT Megah Estetika Perkasa</td>
                          <td>Dermaster</td>
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="msperusahaan-edit.html" class="btn btn-warning" data-toggle="tooltip"
                        ...
                        <tr>
                          <td>002</td>
                          <td>PT Samudera Estetika Perkasa</td>
                          <td>Derma Express</td>
                          <td>
                            <div class="btn-group btn-group-xs">
