    ...
    <div class="wrapper">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a class="btn btn-app" href="<?=site_url('master/User')?>">
              <i class="fas fa-users"></i> Users
            </a>
            <a class="btn btn-app" href="<?=site_url('master/Customer')?>">
              <i class="fas fa-users-cog"></i> Customer
            </a>
            <a class="btn btn-app" href="<?=site_url('master/Klinik')?>">
              <i class="fas fa-clinic-medical"></i> Klinik
            </a>
            <!-- <a class="btn btn-app" href="<?=site_url('master/DataMaster/Menu')?>">
              <i class="fas fa-list"></i> Menu
            </a> -->
            <a class="btn btn-app" href="<?=site_url('master/Brand')?>">
              <i class="fas fa-building"></i> Brand
            </a>
            <a class="btn btn-app" href="<?=site_url('master/HargaPaket')?>">
              <i class="fas fa-dollar-sign"></i> Harga Paket
            </a>
            <a class="btn btn-app" href="<?=site_url('master/JenisPaket')?>">
              <i class="fas fa-list-alt"></i> Jenis Paket
            </a>
            <a class="btn btn-app" href="<?=site_url('master/kategoriPaket')?>">
              <i class="fas fa-list-ol"></i> Kategori Paket
            </a>
            <a class="btn btn-app" href="<?=site_url('master/PeriodePaket')?>">
              <i class="fas fa-calendar-alt"></i> Periode Paket
            </a>
            <a class="btn btn-app" href="<?=site_url('master/StatusPaket')?>">
