          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="msklinik-add.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-append">
                          <a href="<?=site_url('master/DataMaster/KlinikAdd')?>" class="btn btn-primary" data-toggle="tooltip" title="Create">
                  ...
                  <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <tr>
                          <td>01.02.01</td>
                          <td>Dermaster Mangga Besar</td>
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="msklinik-edit.html" class="btn btn-warning" data-toggle="tooltip"
                        ...
                        <tr>
                          <td>01.02.03</td>
                          <td>Dermaster Pantai Indah Kapuk</td>
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="#" class="btn btn-warning" data-toggle="tooltip" title="Edit"><i
                                  class="fas fa-pencil-alt"></i></a>
